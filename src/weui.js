...
var weui = {
	alert : function(msg, title, callback) {
		...
		alertHtml += '      <a href="javascript:;" disabled="disabled" id="weui_dialog_btn_for_weixin" class="weui_btn_dialog primary">确定</a>';
		alertHtml += '  </div>';
		alertHtml += ' </div>';
		alertHtml += '</div>';
	...
	Loading : {
		show : function(msg) {
			...
			weui_loading.find(".weui_toast").css("left", (w) / 2);
		},
		hide : function() {
			if (!weui.destroyFlag)
